...
/**
 * A LabelMapper to allow Dropwizard metrics to be translated to Prometheus metrics including custom
...
public class CustomLabelMapper {
  ...
  static class NameAndLabels {
    ...
    NameAndLabels(
        final String name, final List<String> labelNames, final List<String> labelValues) {
      this.name = name;
